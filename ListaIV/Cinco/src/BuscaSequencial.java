public class BuscaSequencial {
    public static void main(String[] args) {
        ...
        int[] indices65 = buscaIndices(listaNumeros, 65);

        System.out.println("Índices onde o número 65 se encontra na lista:");
        for (int indice : indices65) {
            System.out.println(indice);
        }
    }

    public static int[] buscaIndices(int[] lista, int chave) {
        int count = 0;
